...
import { TrendingUp, ChevronRight, Flame, Star, ExternalLink, Eye, BookOpen } from 'lucide-react';
...
export function Trending() {
  ...
  useAutoScrollLoop({
    ...
    enabled: moreTrendingBooks.length > 0,
    speed: 0.3,
  });
              ...
              >
                {displayMoreTrending.map((book, index) => (
                  <FlipBookCarouselCard
                    ...
                    rank={index < moreTrendingBooks.length ? index + 2 : undefined}
                  />
                ))}
              </div>
            </div>
