...
function HomePage() {
  ...
  return (
    <main>
      {/* 1. Hero – full-width split layout with book covers */}
      <ErrorBoundary section="Hero"><Hero /></ErrorBoundary>

      {/* 2. Recently viewed – personalized (only shows when user has history) */}
      <Suspense fallback={<SectionFallback />}>
        <ErrorBoundary section="Recently Viewed"><RecentlyViewed /></ErrorBoundary>
      </Suspense>

      {/* 3. Trending – primary discovery anchor */}
      <Suspense fallback={<SectionFallback />}>
        <ErrorBoundary section="Trending"><Trending /></ErrorBoundary>
      </Suspense>

      {/* 4. Book of the Day – editorial spotlight */}
      <Suspense fallback={<SectionFallback />}>
      ...
      {/* 5. Categories – genre browsing grid */}
      <Suspense fallback={<SectionFallback />}>
      ...
      {/* 6. New Releases – fresh titles */}
      <Suspense fallback={<SectionFallback />}>
        <ErrorBoundary section="New Releases"><NewReleases /></ErrorBoundary>
      </Suspense>

      {/* 7. Top Rated – curated quality picks */}
      <Suspense fallback={<SectionFallback />}>
      ...
      {/* 8. Reading Challenge – engagement widget */}
      <Suspense fallback={<SectionFallback />}>
      ...
      {/* 12. Reading Stats – platform credibility */}
      <Suspense fallback={<SectionFallback />}>
      ...
      {/* 14. Popular Searches – SEO + discovery */}
      <Suspense fallback={<SectionFallback />}>
