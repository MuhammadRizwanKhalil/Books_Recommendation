...
const en: Record<string, string> = {
  ...
  // Blog extras
  'blog.aiGenerated': 'Featured',
  'blog.autoGenerated': 'Curated',
  'blog.editorial': 'Editorial',
  'blog.aiPowered': 'Featured Content',
  'blog.subtitle': 'Weekly curated reading lists and literary insights from our editors.',
  'blog.viewAllPosts': 'View All Posts',
  'blog.booksFeatured': 'books featured',
  'blog.aiWeekly': 'Fresh Weekly Content',
  'blog.aiWeeklyDesc': 'Fresh reading lists and literary insights curated every week.',
  ...
  'newsletter.aiRecommendations': 'Personalized book recommendations',
